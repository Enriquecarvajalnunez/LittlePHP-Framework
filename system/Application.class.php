...
if ($saveconfiguration != "S") {
    ...
    require_once('./../../lib/adodb-5.20.17/adodb5/adodb.inc.php');
...
class Application
{
    ...
    {
        return Application::__getVar('url');
    }	
	
    public static function &getUrlApp()
    {
        return Application::__getVar('urlapp');
    }		
    ...
    public static function &getEmailsTemplates()
    {
        return Application::getBaseDirectory() . Application::__getVar('emailstemplates_dir');
    }	
	...
	*/
    ...
    public static function &__getVar($nom_var)
    {
        ...
        if (!isset($config)) {
            ...
            // filename = <LITTLE-dir>/applications/config/application.conf.data
    ...
    public static function __setVar($name = "", &$objVar)
    {
        ...
        $obj =& LITTLE::getStaticProperty('Application', 'config');
        $obj[$name] = $objVar;
    }
